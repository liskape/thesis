...
Reprezentace původních skladeb, tedy příslušných $90$ atributů vzniklo netriviální extrakcí z akustických vlastností původních objektů. Tento přístup zabraňuje interpretovat výsledné shluky podle společných vlastností odvozených pouze na základě konkrétních hodnot atributů. Lepším přístupem je interpretovat shluky podle původních objektů, tedy skladeb, což je ovšem záležitost, kterou má v popisu činnosti expert domény. V této části proto nepůjde o interpretaci výsledných shluků, nýbrž o nalezení nějaké struktury. 


Výsledkem této sekce by tak mělo být ujištění, že zvolené metody jsou schopné najít strukturu v kolekcích reprezentací hudebních skladeb v kontextu zvolené sémantiky. Budou voleny takové datasety u kterých předpokládáme vytvoření shluků nejen podle zvolené sémantiky učení. 



\subsection{Kapela jako sémantický kontext}
...
\subsubsection*{Offspring a Sex Pistols}
...
nemáme konkrétní skladby
můžeme posuzovat data z dané sémantiky
i přes konflikty utvořilo koncetrované clustery

lepší zobrazování: crosses

\subsubsection*{Rok 1960 a 1970}
...
- nedaří se odvodit žádnou strukturu pro daný sémantický kontext
- je možné že žádná neni
- clustorování dá vždy clustery?
- 
\begin{figure}
\centering
\begin{subfigure}{.5\textwidth}
...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.99\linewidth]{exp_user_crsom.png}
  \caption{}
  \label{fig:sub2}
\end{subfigure}
\caption{}
...
\subsection{Oblíbenost jako sémantický kontext}

- porovnávat různé výsledky pro různé epochy, ...
...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.99\linewidth]{exp_trend_fail_som.png}
  \caption{}
  \label{fig:sub1}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.99\linewidth]{exp_trend_fail_crsom.png}
  \caption{}
  \label{fig:sub2}
\end{subfigure}
\caption{}
...
\chapter{Použité datasety}
\section{Katy Perry a Ramones (KatyRamDataset)}\label{app:KatyRamDataset}
