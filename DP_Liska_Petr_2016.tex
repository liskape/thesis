...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.99\linewidth]{norm-resmap1300.png}
...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.99\linewidth]{norm-resmap1000.png}
  \caption{Sémantická mapa}
  \label{fig:map1000}
\end{subfigure}
...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.99\linewidth]{norm-resmap400.png}
  \caption{Sémantická mapa}
  \label{fig:resmap400}
\end{subfigure}
...
\begin{figure}[htp]
    ...
    \includegraphics[width=.32\textwidth]{citi0.png}
    \includegraphics[width=.32\textwidth]{citi63.png}
    \includegraphics[width=.32\textwidth]{citi500.png}
...
\begin{figure}[htp]
    ...
    \includegraphics[width=.32\textwidth]{form0.png}
    \includegraphics[width=.32\textwidth]{form63.png}
    \includegraphics[width=.32\textwidth]{form500.png}
...
\begin{figure}[htp]
    ...
    \includegraphics[width=.32\textwidth]{pos0.png}
    \includegraphics[width=.32\textwidth]{pos63.png}
    \includegraphics[width=.32\textwidth]{pos500.png}
...
\section{Kapela jako sémantický kontext}

\subsection{Katy Perry a Ramones}
